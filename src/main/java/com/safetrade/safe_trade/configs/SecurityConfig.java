...
import com.safetrade.safe_trade.models.member.LoginFailureHandler;
import com.safetrade.safe_trade.models.member.LoginSuccessHandler;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(c -> {
            c.requestMatchers("/mypage2/**").authenticated() // 회원 전용(로그인한 회원만 접근 가능)
